  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        disabled={loading}
        className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[var(--primary)] px-6 py-3.5 text-sm font-semibold text-white shadow-lg shadow-[var(--primary)]/20 transition-all hover:bg-[var(--primary-dark)] hover:shadow-xl hover:shadow-[var(--primary)]/30 disabled:opacity-60 sm:text-base"
      >
        {loading ? (
          <>
